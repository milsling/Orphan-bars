...
export default function Messages() {
  ...
  const ConversationList = () => (
    <div className="flex flex-col h-full">
      <Tabs defaultValue="chats" className="flex-1 flex flex-col">
        <TabsList className="w-full rounded-none bg-transparent border-b border-border/50 shrink-0">
  ...
  return (
    <div className="min-h-screen bg-background pt-14 pb-20 md:pb-0 md:pt-16">
      ...
      <main className="max-w-5xl mx-auto h-[calc(100vh-56px)] md:h-[calc(100vh-64px)] md:p-4">
        <div className="h-full md:rounded-2xl md:border md:border-border/50 md:bg-card/50 md:backdrop-blur-sm overflow-hidden flex">
          
          <div className="hidden md:flex w-80 border-r border-border/50 flex-col bg-background/50">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <div className="md:hidden flex items-center gap-3 p-3 border-b border-border/50 bg-background/80 backdrop-blur-sm">
